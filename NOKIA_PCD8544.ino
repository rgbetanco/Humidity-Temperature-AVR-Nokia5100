/*
 * Display Temperature and Humidity using 
 * Nokia LCD - as for today analogRead is not working properly
 */
...
void loop(void)
{
  ...
  float voltage_temp = ((tempValue*5.0)/1023.0);
  ...
  char hBuf[4];
  h.toCharArray(hBuf, 4);

  String t = String(temperature);
  char tBuf[4];
  t.toCharArray(tBuf, 4);
